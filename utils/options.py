...
def args_parser():
    ...
    # federated arguments
    parser.add_argument('--epochs', type=int, default=200, help="rounds of training")#10
    parser.add_argument('--num_users', type=int, default=50, help="number of users: n")#100
    ...
    parser.add_argument('--alg', type=str, default='fdrl', help='FL algorithm to use')
    ...
    parser.add_argument('--gpu', type=int, default=6, help="GPU ID, -1 for CPU")
